...
public class EditTransactionCommand extends Command {
    ...
    public static final String COMMAND_WORD = CommandType.EDIT_TRANSACTION.getCommandWords();
    public static final String MESSAGE_USAGE = CommandType.EDIT_TRANSACTION.getMessageUsage();


    public static final String MESSAGE_EDIT_TRANSACTION_SUCCESS = CommandType.EDIT_TRANSACTION.getMessageSuccess();
    public static final String MESSAGE_NOT_EDITED = CommandType.EDIT_TRANSACTION.getMessageFailure();
